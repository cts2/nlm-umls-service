...
class AggregateSetDefinitionReadService extends AbstractService with ValueSetDefinitionReadService {
  ...
  @Resource
  var ushikValueSetDefinitionReadService:UshikValueSetDefinitionReadService = _

  @Resource
  var phinVadsValueSetDefinitionReadService:PhinVadsValueSetDefinitionReadService = _
  ...
  def readByTag(
    ...
    val ushik = ushikValueSetDefinitionReadService.readByTag(valueSet, tag, readContext)
    if(ushik != null){
      ushik
    } else {
      phinVadsValueSetDefinitionReadService.readByTag(valueSet, tag, readContext)
    }
